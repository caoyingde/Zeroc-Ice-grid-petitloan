package com.huilian.petitcredit.base.pushmsg.utils.fastDFS;
...
public class FileHandler {
    ...
    private static String FDFS_CLIENT_NAME   = "config.properties";
     ...
     */
    private static String DEFAULT_GTROUP = "N1";
  ...
  /*   filePath = "G1/M00/00/7B/CgoBKlkuZ9CALzSWAAXUHJmYPkA114.jpg";
        int data = util.deleteFileForFile(filePath);
        System.out.println("fileInfo ： " + data);*/
        System.out.println("fileInfo ： " + fileInfo.getFilePath());
    }
